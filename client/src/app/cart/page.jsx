  ...
  return (
    <div>
      ...
      <div className="h-screen bg-green-100 pt-20">
        <h1 className="mb-10 pt-10 text-center text-green-600 text-2xl font-bold">Cart Items</h1>
            ...
            <div className="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
              ...
              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                <div className="mt-5 sm:mt-0">
                  ...
                  <p className="mt-1 text-xs text-gray-700">Iconic GG Marmont Matelassé Shoulder Bag from Gucci</p>
                </div>
            ...
            <div className="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
              ...
              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                <div className="mt-5 sm:mt-0">
                  ...
                  <p className="mt-1 text-xs text-gray-700">Stylish Baguette Bag from Fendi</p>
                </div>
